...
//const { combineStrings } = require("./utils_testing");
//const { stringToUint8ArrayUtf8 } = require("skynet-js");
//const { makeUrl } = require("./utils");
//const buildRequestUrl = makeUrl;
//const portalUrl = DEFAULT_SKYNET_PORTAL_URL;
//const client = new SkynetClient(portalUrl);

const { deriveChildSeed, genKeyPairAndSeed, genKeyPairFromSeed, hashDataKey, hashRegistryEntry } = require("./crypto");
